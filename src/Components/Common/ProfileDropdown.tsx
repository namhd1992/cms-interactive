...
const ProfileDropdown = () => {
    ...
    useEffect(() => {
        ...
        if (authUSer) {
            ...
            setUserName(obj.data.nick_name);

            // setUserName(import.meta.env.VITE_APP_DEFAULTAUTH === "fake" ? obj.username === undefined ? user.first_name ? user.first_name : obj.data.first_name : "Admin" || "Admin" :
