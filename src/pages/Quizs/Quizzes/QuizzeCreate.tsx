...
const QuizsCreate = () => {
    ...
    document.title = "Create Quizs | Velzon - React Admin & Dashboard Template";
    ...
    const validation: any = useFormik({
        ...
        onSubmit: (values) => {
            ...
            dispatch(onAddNewQuizs(newInvoice));
    ...
    return (
        <div className="page-content">
            <Container fluid>
                <BreadCrumb title="Create Quizs" pageTitle="Quizs" />
